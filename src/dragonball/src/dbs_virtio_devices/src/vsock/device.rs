...
use crate::{
    ActivateResult, ConfigResult, DbsGuestAddressSpace, VirtioDevice, VIRTIO_F_IN_ORDER,
    VIRTIO_F_IOMMU_PLATFORM, VIRTIO_F_VERSION_1,
};
const VSOCK_DRIVER_NAME: &str = "virtio-vsock";
const VSOCK_CONFIG_SPACE_SIZE: usize = 8;
const VSOCK_AVAIL_FEATURES: u64 =
    1u64 << VIRTIO_F_VERSION_1 | 1u64 << VIRTIO_F_IN_ORDER | 1u64 << VIRTIO_F_IOMMU_PLATFORM;
