...
impl KvmContext {
    ...
    /// Get underline KVM object to access kvm-ioctls interfaces.
    pub fn kvm(&self) -> &Kvm {
        &self.kvm
    }
    ...
    fn build_msrs_list(kvm: &Kvm) -> Result<Msrs> {
        ...
        let supported_msr_list = kvm.get_msr_index_list().map_err(Error::Kvm)?;
        ...
        */
        ...
        Msrs::from_entries(&msrs).map_err(Error::Msr)
    }
}
