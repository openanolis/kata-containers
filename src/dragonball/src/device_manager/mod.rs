...
pub type DbsMmioV2Device =
    MmioV2Device<GuestAddressSpaceImpl, virtio_queue::QueueState, GuestRegionMmap>;

/// Struct to provide operation transaction for device management.
...
///
/// Currently it's used to support PCI device hotplug and PCI BAR reprogramming.
/// Actually the DeviceManagerContext and DeviceOpContext should be merged after we have switched
/// to the new vmm_epoll implementation.
#[derive(Clone)]
...
impl DeviceManager {
    ...
    pub fn new(
        ...
        DeviceManager {
            ...
            irq_manager: Arc::new(KvmIrqManager::new(vm_fd)),
            res_manager,
    ...
    /// Restore legact device when doing LiveUpgrade
