...
use crate::config_manager::{ConfigItem, DeviceInfoGroup, DeviceInfoList};
...
pub enum VsockDeviceError {
    ...
    #[error("vsock id {0} is already exist")]
...
/// Vsock Device Info
pub type VsockDeviceInfo = DeviceInfoGroup<VsockDeviceConfigInfo>;

/// Device manager to manage all vsock devices.
pub struct VsockDeviceMgr {
    info_list: DeviceInfoList<VsockDeviceConfigInfo>,
    default_inner_backend: Option<VsockInnerBackend>,
    default_inner_connector: Option<VsockInnerConnector>,
    use_shared_irq: bool,
}
