...
use dragonball::{
    api::v1::{
        ...
        InstanceInfo, InstanceState, VirtioNetDeviceConfigInfo, VmResizeInfo, VmmAction,
...
impl VmmInstance {
    ...
    pub fn resize_vm(&self, cfg: &VmResizeInfo) -> Result<()> {
        self.handle_request(Request::Sync(VmmAction::VmResize(cfg.clone())))
